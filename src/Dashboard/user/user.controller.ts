...
export class UserController {
  ...
  async updateUser(
    ...
    const result = await this.userService.updateUser(id, updateUserDto, req['user']);
    return {
  ...
  async activateUser(@Param('id') id: string, @Req() req: Request) {
    const result = await this.userService.activateUser(id, req['user']);
    return {
  ...
  async deleteUser(@Param('id') id: string, @Req() req: Request) {
    await this.userService.softDeleteUser(id, req['user']);
    return {
